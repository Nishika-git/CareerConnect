...
import { sendConnectionRequest, getConnectionsRequest , getMyConnectionsRequests} from '@/config/redux/action/authAction';
                        ...
                        <div style={{
                            ...
                            <div style={{ display: "flex", alignItems: "center", gap: "1.2rem"}}>
                                {isCurrentUserInConnection ?
                                    <button style={{ maxWidth: "16%" }} className={styles.connectedButton}>{isConnectionNull ? "Pending" : "Connected"}</button>
                                    :
                                    <button onClick={() => {
                                        dispatch(sendConnectionRequest({ token: localStorage.getItem("token"), user_id: userProfile.userId._id }))
                                    }} style={{ maxWidth: "14%" }} className={styles.connectBtn}>Connect</button>
                                }
