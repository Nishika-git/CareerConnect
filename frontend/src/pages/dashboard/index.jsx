...
import { deletePost, getAllPosts, incrementPostLike, getAllComments, delete_comment_of_user, postComment } from "@/config/redux/action/postAction";
                                        ...
                                        <div key={post._id} className={styles.singleCard}>
                                            <div className={styles.singleCard_profileContainer}>
                                                ...
                                                <div>
                                                    ...
                                                    <p style={{ paddingTop: "1.3rem", whiteSpace: "pre-wrap" }}>{post.body}</p>
                        ...
                        <div onClick={() => {
                            ...
                            <div onClick={(e) => {
                                            ...
                                            return (
                                                ...
                                                <div className={styles.singleComment} key={postComment._id}>
                                                    <div className={styles.singleComment_profileContainer}>
                                                        ...
                                                        <div>
                                                            <div style={{ display: "flex", justifyContent: "space-between", gap: "1rem", alignItems: "center", justifyContent: "center", top: "1.2rem" }}>                          <p style={{ fontWeight: "bold", fontSize: "1.2rem" }}>{postComment.userId.name}</p>{
                                                                postComment.userId._id === authState.user.userId._id &&
                                                                <div onClick={async () => {
                                                                    await dispatch(delete_comment_of_user(postComment._id))
                                                                    await dispatch(getAllComments());
                                                                }} style={{ cursor: "pointer", alignItems: "center", justifyContent: "center !important", bottom: "-1.2rem !important" }}>
                                                                    <svg style={{ height: "1.1em", color: "red" }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                                                                        <path strokeLinecap="round" strokeLinejoin="round" d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 0 1 3.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 0 0-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 0 0-7.5 0" />
                                                                    </svg>
                                                                </div>
                                                            }
                                ...
                                <div className={styles.postCommentContainer}>
                                    <img className={styles.commentUserProfile} src={`${BASE_URL}/${authState.user.userId.profilePicture}`} alt="" />
